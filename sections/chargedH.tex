...
\label{sec:samplesCh}
\input{sections/mcChargedH.tex}

\section{Object Selection}
\label{sec:objCh}
\input{sections/objChargedH.tex}

\section{Event Selection}
\label{sec:evSelCh}
\input{sections/eventSelChargedH.tex}

\section{Background Modelling}
\label{sec:bkgCh}
\input{sections/bkgChargedH.tex}

\section{Systematic Uncertainties and Statistical Methods}
\label{sec:systsCh}
\input{sections/systsChargedH.tex}

\section{Results}
\label{sec:resCh}
\input{sections/resultsChargedH.tex}
